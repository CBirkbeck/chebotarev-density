...
**Composition**: unramified ⟹ inertia trivial
(`inertiaGroup_trivial_of_unramified`), then the trivial-inertia case
(`exists_unique_frobeniusAt_of_inertia_trivial`) supplies the unique `σ`. -/
