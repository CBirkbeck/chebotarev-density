...
theorem ncard_index_image_le_of_diam_le (n : ℕ) {T : Set (ι → ℝ)} {r : ℝ}
...
theorem ncard_index_image_chart_le {κ : Type*} [Fintype κ] {M : ℝ≥0}
  ...
  have hpiece : ∀ v : κ → ℤ,
    ...
    refine (ncard_index_image_le_of_diam_le n hdimg hbddφ).trans ?_
