...
\begin{definition}\label{def:unramified-in}
  ...
  \leanok
  A prime ideal $\fp$ of $\OK$ is \emph{unramified in $L$} if every
  maximal prime $\fP$ of $\Ocirc_L$ lying over $\fp$ is unramified over
  $\OK$ (for nonzero $\fp$: ramification index $1$, i.e.\ $\fp\Ocirc_L$
