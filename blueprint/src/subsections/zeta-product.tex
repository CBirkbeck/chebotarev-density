...
\begin{lemma}\label{lem:artin-analytic-extension}
  \lean{Chebotarev.artinLSeries_analytic_extension}
...
\begin{proof}
  Combine \cref{lem:character-sum-geom-numbers} (Sharifi 7.1.19 step 1a)
...
\begin{lemma}\label{lem:artin-one-ne-zero}
  ...
  extension of \cref{lem:artin-analytic-extension}.)
\end{lemma}
